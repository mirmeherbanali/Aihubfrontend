 ...
 export default function CategorySlugPage({ params }: { params: { toolname: string } }) {
   const slug = useCategoryStore((s: any) => s.slug);

   const decodedSlug = unslugify(slug);
   const decodedTool = unslugify(params.toolname);
   const [currentPage, setCurrentPage] = useState(1);
   
   const toolsPerPage = 6;
     const clear = useCategoryStore((s: any) => s.clear);
