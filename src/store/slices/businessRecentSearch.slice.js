...
export const createRecentSearch = createAsyncThunk(
    "individual/recentSearch/createRecentSearch",
    async (payload, { rejectWithValue }) => {
        try {
            const response = await fetchAPI({
                url: process.env.NEXT_PUBLIC_API_URL + "/individual/recentSearch/createRecentSearch",
                method: "POST",
...
export const getAllRecentSearches = createAsyncThunk(
    "individual/recentSearch/getAllRecentSearches",
    async (payload, { rejectWithValue }) => {
        try {
            const response = await fetchAPI({
                url: process.env.NEXT_PUBLIC_API_URL + "/individual/recentSearch/getAllRecentSearches",
                method: "POST",
                headers: "Content-Type:application/json",
                body: payload,
            });
